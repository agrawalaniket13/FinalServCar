...
const UpdateMechanic = () => {
    ...
    console.log(location.state.mechanic.name);
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        dispatch(mechanicActions.updMechanic(mechanic))
            ...
            <Form className='container w-50 h-auto d-flex my-5'>
                <div style={{ width: '100%', "border": "solid 0.5px #C0C0C0", "padding": "15px", "alignContent": "center", "boxShadow": "rgba(0, 0, 0, 0.35) 0px 5px 15px" }}>
                    <div style={{
                        ...
                        <h5 style={{ "color": "white", "paddingTop": "5px" }}>Update Mechanic</h5>
                    </div>
                    <FormGroup>
                        <div className='p-2'>
                    ...
                    <Button onClick={handleSubmit} style={{ "backgroundColor": "#007580" }}>Update Mechanic</Button><br /><br />
                </div>
            </Form>
        </Container>
    )
